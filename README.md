...
Unfortunately Spotify requires you to do this every 6 months, plus if the user
or Spotify details in the config file change. This involves logging into
Spotify as the desired user, via a URL generated by the script.
...
retrieval functions should work for about 6 months. If the script is run and
cannot detect usable credentials, it will throw an error.
